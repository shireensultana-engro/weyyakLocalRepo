	...
	return []SyncMovieImage{
		{
			...
			ImageURL: []string{
				fmt.Sprintf("https://content.weyyak.com/%s/poster-image", ID),
			},
		},
		{
			ImageCategory: "detailsPageBackground",
			ImageURL: []string{
				fmt.Sprintf("https://content.weyyak.com/%s/details-background", ID),
			},
		},
		{
			ImageURL: []string{
				fmt.Sprintf("https://content.weyyak.com/%s/mobile-details-background", ID),
			},
		...
		},
		{
			...
			ImageURL: []string{
				fmt.Sprintf("https://content.weyyak.com/%s/overlay-poster-image", ID),
			},
		},
	}
