...
// 	rel.Rel = "prev"
// 	href.Rel = "next"
// 	rel.Href = "https://msapifo-prod-me.weyyak.z5.com/mrss/feed?page=" + strconv.Itoa(int(current_page)-1)
// 	href.Href = "https://msapifo-prod-me.weyyak.z5.com/mrss/feed?page=" + strconv.Itoa(int(current_page)+1)
// 	part.Href = href
// 	part.Rel = rel
...
func (hs *HandlerService) mrssfeed(c *gin.Context) {
	...
	for _, val := range contentdetails {
		...
		// imagery
		if val.SeasonId != "" {
			temp.Thumbnail.URL = "https://content.weyyak.com/" + val.Id + "/" + val.SeasonId + "/" + val.EpisodeId + "/poster-image"

		} else {
			temp.Thumbnail.URL = "https://content.weyyak.com/" + val.Id + "/poster-image"
		}
		for i := 0; i < 2; i++ {
			var temps Content
			if i == 0 {
