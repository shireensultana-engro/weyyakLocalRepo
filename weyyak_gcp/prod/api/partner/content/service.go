...
func (hs *HandlerService) Bootstrap(r *gin.Engine) {
	...
	srgc.Use(common.ValidateToken())

	srg.GET("/get_menu", hs.GetMenuDetails)
	srg.GET("/get_page/:pageId", hs.GetPageDetails)
	srg.GET("/get_info/:videoId", hs.GetVideoDuration)

	srg = srg.Group("/contents/onetier")
	srgc = srgc.Group("/contents/multitier")
	srg.GET(":contentId", hs.GetOneTierContentDetailsBasedonContentID)
	srg.GET("", hs.GetAllOneTierContentDetails)
	srgc.GET(":contentId", hs.GetMultiTierDetailsBasedonContentID)
	srgc.GET("", hs.GetAllMultiTierDetails)
	srgc.GET("/episode/:contentId", hs.GetEpisodeDetailsByEpisodeId)
	// srg.GET("/get_menu", hs.GetMenuDetails)
	// srg.GET("/get_page/:pageId", hs.GetPageDetails)
	// srg.GET("/get_info/:videoId", hs.GetVideoDuration)
}
