...
export USER_LOG_URL=https://msapiprod-me-events.z5.com/event/log 
...
export GCP_URLFORCONFIG=https://storage.googleapis.com/weyyak-prod/configprodmigration.json 
