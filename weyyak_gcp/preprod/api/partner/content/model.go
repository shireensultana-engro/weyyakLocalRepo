...
type MultiTierContentGenresName struct {
	GenerEnglishName string `json:"english_name"`
	GenerArabicName  string `json:"arabic_name"`
}
...
type Episode struct {
	...
	EnglishMetaDescription string    `json:"english_meta_description"`
	ArabicMetaDescription  string    `json:"arabic_meta_description"`
	ThirdPartyEpisodeKey   int       `json:"third_party_episode_key"`
}
...
type ContentDetails struct {
	...
	SeoTitle              string                `json:"seo_title"`
	Imagery               ContentImageryDetails `json:"imagery"`
	InsertedAt            time.Time             `json:"-,omitempty"`
