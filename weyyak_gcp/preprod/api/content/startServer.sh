...
export DB_DATABASE=wyk_content1 \
export FRONTEND_DB_DATABASE=wk_frontend1 \
...
export BASE_URL=https://msapifo-prod-me.weyyak.z5.com/v1/ \
...
export S3_BUCKET=z5content \
export S3_REGION=ap-south-1 \
export S3_ID=AKIAYOGUWMUMLWREWLMX \
export S3_SECRET=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 \
export REDIS_RDS=34.18.63.111:6379 \
...
export BUCKET_NAME=weyyak-prod \
export TYPE=service_account \
export PROJECT_ID=weyyak-preprod \
export PRIVATE_KEY_ID=ca04f32ec04c7f308872a2230187e8731b7f87ea \
...
export CLIENT_EMAIL=weyyak-preprod@weyyak-preprod.iam.gserviceaccount.com \
export CLIENT_ID=104965307123923002514 \
...
export CLIENT_X509_CERT_URL=https://www.googleapis.com/robot/v1/metadata/x509/weyyak-preprod%40weyyak-preprod.iam.gserviceaccount.com \
