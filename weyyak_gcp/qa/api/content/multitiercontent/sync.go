	...
	return []SyncMovieImage{
		{
			...
			ImageURL: []string{
				fmt.Sprintf("https://weyyak-content-qa.engro.in/%s/poster-image", ID),
			},
		},
		{
			ImageCategory: "detailsPageBackground",
			ImageURL: []string{
				fmt.Sprintf("https://weyyak-content-qa.engro.in/%s/details-background", ID),
			},
		},
		{
			ImageURL: []string{
				fmt.Sprintf("https://weyyak-content-qa.engro.in/%s/mobile-details-background", ID),
			},
		...
		},
		{
			...
			ImageURL: []string{
				fmt.Sprintf("https://weyyak-content-qa.engro.in/%s/overlay-poster-image", ID),
			},
		},
	}
