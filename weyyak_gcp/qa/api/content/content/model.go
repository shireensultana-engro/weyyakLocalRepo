...
type ContentVariance struct {
	...
	IntroDuration         int    `json:"intro_duration"`
}
...
type ContentSeasonsQueryDetails struct {
	...
	AtciIntroStart         *string   `json:"atci_intro_start"`
	OutroDuration          *string   `json:"outro_duration"`
	AtciOutroStart         *string   `json:"atci_outro_start"`
...
type AboutTheContentInfoRequest struct {
	...
	ProductionHouse       string `json:"productionHouse"`
	AgeGroup              int    `json:"ageGroup" binding:"required"`
	IntroDuration         string `json:"introDuration" binding:"required"`
	IntroStart            string `json:"introStart" binding:"required"`
