...
func LanguageIdToCode(country int) string {
	countryArray := map[int]string{1: "en", 2: "ar", 3: "fr", 4: "tr", 5: "hi", 6: "ur", 7: "ir", 8: "ko", 9: "es", 10: "pt"}
	return countryArray[country]
}

func GetRedisDataWithKey(c *gin.Context, key string) (string, error) {
...
func BadRequestErrorResponse() BadRequestError {
	...
	badRequestError.RequestId = "qayhdbgncgcfrstebfjfndu"
	return badRequestError
}

func ServerErrorResponses(language string) ServerError {
	var serverError ServerError
	serverError.Error = SERVER_ERROR
	serverError.Description = EN_SERVER_ERROR_DESCRIPTION
	if language != "en" {
	...
	serverError.Code = SERVER_ERROR_CODE
	serverError.RequestId = "qayhdbgncgcfrstebfjfndu"
	return serverError
}
