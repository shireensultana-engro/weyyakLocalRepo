	...
	return []SyncMovieImage{
		{
			...
			ImageURL: []string{
				fmt.Sprintf("https://content-uat.weyyak.com/%s/poster-image", ID),
			},
		},
		{
			ImageCategory: "detailsPageBackground",
			ImageURL: []string{
				fmt.Sprintf("https://content-uat.weyyak.com/%s/details-background", ID),
			},
		},
		{
			ImageURL: []string{
				fmt.Sprintf("https://content-uat.weyyak.com/%s/mobile-details-background", ID),
			},
		...
		},
		{
			...
			ImageURL: []string{
				fmt.Sprintf("https://content-uat.weyyak.com/%s/overlay-poster-image", ID),
			},
		},
	}
