...
export IMAGE_URL=https://weyyak-content-dev.engro.in/ 
export VIDEO_API=https://api-weyyak.akamaized.net/get_info/ 
export LOGIN_API=https://apiqafo.engro.in/v1/oauth2/token 
...
export IMAGERY_URL=https://weyyak-content-dev.engro.in/
