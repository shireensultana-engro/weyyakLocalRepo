...
type MainResponse struct {
	// for removing sync below ContentId and ContentKey were commented
...
type SeoDetailsResponse struct {
	...
	ThirdPartyContentKey   int       `json:"third_party_content_key"`
	Status                 int       `json:"status"`
	ContentType            string    `json:"contenttype"`
...
type SyncMoviePayload struct {
	ContentType           string             `json:"contentType"`
	Notes                 string             `json:"notes"`
	Rights                []SyncMovieRights  `json:"rights"`
	AcquisitionDepartment string             `json:"acquisitionDepartment"`
	Status                string             `json:"status"`
	Products              []int              `json:"products"`
	...
	Trailers              []VarianceTrailers `json:"trailers"`
	TransliteratedTitle   string             `json:"transliteratedTitle"`
	ID                    string             `json:"Id"`
	Supplier              string             `json:"supplier"`
	Synopsis              string             `json:"synopsis"`
	Cast                  []SyncMovieCast    `json:"cast"`
	IntroStart            string             `json:"introStart"`
	Key                   int                `json:"key"`
	...
	Images                []SyncMovieImage   `json:"images"`
	OriginalLanguage      string             `json:"originalLanguage"`
	OutroStart            string             `json:"outroStart"`
	ProductionYear        string             `json:"productionYear"`
	SubGenre              []string           `json:"subGenre"`
	CreatedAt             SyncMovieDate      `json:"createdAt"`
	MetaDescription       string             `json:"metaDescription"`
}

type SyncMovieRights struct {
...
// {
// 	Platform:           []string{"AllPlatforms"},
// 	Rights:             "AVOD",
// 	SchedulingDateTime: "",
// 	StartDate:          "2023-02-08T00:00:00Z",
// 	EndDate:            "2026-02-02T00:00:00Z",
// 	Location:           []string{"AllLocations"},
// 	Plan:               "NormalPlan",
// },

type SyncMovieCast struct {
	Details string `json:"details"`
	Name    string `json:"name"`
	Type    string `json:"type"`
}

type SyncMovieImage struct {
	ImageCategory string   `json:"imageCategory"`
	ImageURL      []string `json:"imageUrl"`
}

type SyncMovieDate struct {
