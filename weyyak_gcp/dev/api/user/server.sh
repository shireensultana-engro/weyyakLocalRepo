...
export REDIRECTION_URL=https://weyyak-dev.engro.in/ 
...
export PASSWORDCHANGEURL=https://backoffice-dev.engro.in/password? 
...
export BASE_URL=https://weyyak-dev.engro.in
export EGYPTBASE_URL=https://qa-weyyak1.z5.com 
export SUBSCRIPTION_URL=https://zpmsapi-dev.engro.in/orders/ 
export USER_DELETE_URL=https://zpmsapi-dev.engro.in/payment/registration/delete?id= 
