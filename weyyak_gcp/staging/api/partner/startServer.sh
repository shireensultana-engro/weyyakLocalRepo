...
export IMAGE_URL=https://contents-stg.weyyak.z5.com/ 
export VIDEO_API=https://api-weyyak.akamaized.net/get_info/ 
export LOGIN_API=https://msapifo-stg-me.weyyak.z5.com/v1/oauth2/token  
export CONTENT_URL=https://apistg.weyyak.z5.com/v1/get_info/ 
export IMAGE_URL_GO=https://contents-stg.weyyak.z5.com/ 
...
export IMAGERY_URL=https://contents-stg.weyyak.z5.com/ 
