...
export	CMS=https://msapifo-stg-me.weyyak.z5.com/v1/ \
export  UM=https://msapifo-stg-me.weyyak.z5.com/v1/ \
export  IMAGES=https://contents-stg.weyyak.z5.com/ \
export  GEO_LOCATION=https://geo-stg.weyyak.com \
...
export  BASE_URL=https://msapifo-stg-me.weyyak.z5.com/ \
...
export  REDIS_CACHE_URL=https://msapistage-me-events.z5.com/v1/cache \
export  DOTNET_URL=https://api-backoffice-production.weyyak.com/oauth2/tokendata?access_token= \
export  BUCKET_NAME=weyyak-stage \
export  TYPE=service_account \
export  PROJECT_ID=wyk-stage \
export  PRIVATE_KEY_ID=fd9feef48aacb563b85d9a1e4b957a325c1e9187 \
...
export  CLIENT_EMAIL=weyyak-stage@wyk-stage.iam.gserviceaccount.com \
export  CLIENT_ID=102280627070321861141 \
...
export  CLIENT_X509_CERT_URL=https://www.googleapis.com/robot/v1/metadata/x509/weyyak-stage%40wyk-stage.iam.gserviceaccount.com \
