...
const docTemplate = `{
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/config.ConfigurationDetails"
                            }
                        }
                    }
                }
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/country.CountryDetails"
                            }
                        }
                    }
                }
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/menu.SideMenuDetails"
                            }
                        }
                    }
                }
    ...
    "definitions": {
        ...
        "menu.FeaturedDetails": {
            ...
            "properties": {
                ...
                "playlists": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/menu.FeaturedPlaylists"
                    }
                },
                "type": {
                    "type": "string"
        ...
        "menu.FeaturedPlaylists": {
            "type": "object",
            "properties": {
                "content": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/menu.PlaylistContent"
                    }
                },
                "id": {
                    "type": "integer"
        ...
        "menu.GetMenu": {
            ...
            "properties": {
                "data": {
                    "$ref": "#/definitions/menu.MenuPageDetails"
                }
            }
        },
        "menu.ImageryDetails": {
        ...
        "menu.MenuPage": {
            ...
            "properties": {
                "featured": {
                    "$ref": "#/definitions/menu.FeaturedDetails"
                },
                "friendly_url": {
                    "type": "string"
                },
                ...
                "imagery": {
                    "$ref": "#/definitions/menu.ImageryDetails"
                },
                "playlists": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/menu.MenuPlaylists"
                    }
                },
                "seo_description": {
                    "type": "string"
        ...
        "menu.MenuPlaylists": {
            ...
            "properties": {
                ...
                "pagecontent": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/menu.PageContent"
                    }
                },
                "playlisttype": {
                    "type": "string"
        ...
        "menu.PlaylistContent": {
            ...
            "properties": {
                ...
                "geoblock": {
                    "description": "InsertedAt      time.Time                ` + "`" + `json:\"insertedAt\"` + "`" + `\nModifiedAt      time.Time                ` + "`" + `json:\"modifiedAt\"` + "`" + `",
                    "type": "boolean"
                },
                "id": {
                    "type": "integer"
                ...
                "movies": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/menu.PlaylistMovie"
                    }
                },
                "production_year": {
                    "type": "integer"
                ...
                "seasons": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/menu.PlaylistContentSeasons"
                    }
                },
                "seo_description": {
                    "type": "string"
