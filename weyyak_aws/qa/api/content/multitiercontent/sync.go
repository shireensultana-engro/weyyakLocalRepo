	...
	return []SyncMovieImage{
		{
			...
			ImageURL: []string{
				fmt.Sprintf("https://contents-uat.weyyak.z5.com/%s/poster-image", ID),
			},
		},
		{
			ImageCategory: "detailsPageBackground",
			ImageURL: []string{
				fmt.Sprintf("https://contents-uat.weyyak.z5.com/%s/details-background", ID),
			},
		},
		{
			ImageURL: []string{
				fmt.Sprintf("https://contents-uat.weyyak.z5.com/%s/mobile-details-background", ID),
			},
		...
		},
		{
			...
			ImageURL: []string{
				fmt.Sprintf("https://contents-uat.weyyak.z5.com/%s/overlay-poster-image", ID),
			},
		},
	}
