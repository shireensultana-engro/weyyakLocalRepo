...
type MultiTireContent struct {
	...
	CreatedAt      time.Time          `json:"createdAt"`
	ModifiedAt     time.Time          `json:"modifiedAt"`
	ContentId      string             `json:"contentId"` //content ID
}
...
type EpisodeDetailsMultiTire struct {
...
type FetchEpisodeDetailsMultiTire struct {
	EpisodeNumber       int            `json:"episdoeNumber"`
	EpisodeKey          int            `json:"episodeKey"`
	Length              int            `json:"length"`
	VideoContentId      string         `json:"videoContentId"`
...
type ContentSeasons struct {
	...
	DigitalRightsRegions  []int                 `json:"digitalRightsRegion,omitempty"`
	SeasonId              string                `json:"seasonId"` //season ID
}
...
type Cast struct {
	...
	WriterIds          []string `json:"writerIds"`
...
type FinalSeasonResult struct {
	SeasonNumber               int       `json:"seasonNumber"`
	SeasonKey                  int       `json:"seasonKey"`
	MultiTierContentKey        string    `json:"multiTiercontentKey"`
	ModifiedAt                 time.Time `json:"modifiedAt"`
	InsertedAt                 time.Time `json:"insertedAt"`
	OriginalTitle              string    `json:"originalTitle"`
	AlternativeTitle           string    `json:"alternativeTitle"`
