...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/content/digitalrights/regions/all": {
            "get": {
                "security": [
                    {
                        "Authorization": []
        ...
        "/api/contents/multitier/published": {
            "post": {
                "security": [
                    {
                        "Authorization": []
        ...
        "/api/contents/multitier/{id}/status/{status}": {
            "post": {
                "security": [
                    {
                        "Authorization": []
        ...
        "/api/contents/onetier/published/{id}": {
            "post": {
                "security": [
                    {
                        "Authorization": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/dashboard.Content"
                            }
                        }
                    }
                }
        ...
        "/seasons/{id}/digitalrightstype/{status}": {
            "post": {
                "security": [
                    {
                        "Authorization": []
    ...
    "definitions": {
        ...
        "dashboard.Dashboard": {
            ...
            "properties": {
                "userByRegion": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dashboard.UserByRegion"
                    }
                },
                "userDevicesresponse": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dashboard.UserDevicesresponse"
                    }
                },
                "watchedContent": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/dashboard.WatchedContent"
                    }
                }
            }
        },
        "dashboard.UserByRegion": {
            "type": "object",
            "properties": {
                "regionName": {
                    "type": "string"
        ...
        "episode.Episodes": {
            ...
            "properties": {
                ...
                "episodeKey": {
                    "description": "episodeId for creating old contents",
                    "type": "integer"
                },
                "music": {
                ...
                "seasonId": {
                    "description": "CreatedByUserId     string          ` + "`" + `json:\"userId\"` + "`" + `             // userid for creating old contents",
                    "type": "string"
                },
                "secondaryEpisodeId": {
                    "description": "episodeId for creating old contents",
        ...
        "multitiercontent.MainResponse": {
            ...
            "properties": {
                ...
                "contentId": {
                    "description": "taking content id from request body for creating old contents",
                    "type": "string"
                },
                "contentKey": {
                    "description": "taking content key from request body for creating old contents",
                    "type": "integer"
                },
                "primaryInfo": {
                    "description": "CreatedByUserId string          ` + "`" + `json:\"userId\"` + "`" + ` // taking created by user id from request body for creating old contents",
