...
// 	rel.Rel = "prev"
// 	href.Rel = "next"
// 	rel.Href = "https://msapifo.weyyak.z5.com/mrss/feed?page=" + strconv.Itoa(int(current_page)-1)
// 	href.Href = "https://msapifo.weyyak.z5.com/mrss/feed?page=" + strconv.Itoa(int(current_page)+1)
// 	part.Href = href
// 	part.Rel = rel
...
// 	ax := "https://contents-uat.weyyak.z5.com/"
// 	ay := "https://wyk2qa.weyyak.com/en"
// 	d := "https://wyk2qa.weyyak.com/ar"
...
func (hs *HandlerService) mrssfeed(c *gin.Context) {
	...
	if current_page > 2 {
		for i := 0; i < 2; i++ {
			if i == 0 {
				links.Rel = "prev"
				links.Href = "https://v49i5nv633.execute-api.me-south-1.amazonaws.com/mrss/feed?page=" + strconv.Itoa(int(current_page-1))
	...
	for _, val := range contentdetails {
		...
		// imagery
		if val.SeasonId != "" {
			temp.Thumbnail.URL = "https://contents-uat.weyyak.z5.com/" + val.Id + "/" + val.SeasonId + "/" + val.EpisodeId + "/poster-image"

		} else {
			temp.Thumbnail.URL = "https://contents-uat.weyyak.z5.com/" + val.Id + "/poster-image"
		}
		for i := 0; i < 2; i++ {
			var temps Content
			if i == 0 {
